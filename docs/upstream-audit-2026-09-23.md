...
| [#549 Plugin Doctor registration drift](https://github.com/stephenschoettler/hermes-lcm/issues/549) | Verified against installed Hermes 2026-09-24 | `hermes plugins doctor hermes-lcm --ci` reports discovery/manifest/import/registration pass, 15 tools and 5 hooks, with no registration warnings. The maintenance guide's older 4-hook count was corrected; re-run Doctor after host/plugin upgrades instead of relying on a pinned count. |
